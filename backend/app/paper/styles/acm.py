...
ACM = StyleSheet(
    ...
    code_caption=Style(font=F, size_pt=8, alignment="left", space_before_pt=6, space_after_pt=2,
                       line_spacing=1.0, first_line_indent_in=0.0, keep_with_next=True),
    code=Style(font="Courier New", size_pt=8, alignment="left", left_indent_in=0.25,
               hanging_indent_in=0.15, space_before_pt=4, space_after_pt=4, line_spacing=1.0),
