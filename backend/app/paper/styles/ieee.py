...
IEEE_1COL = StyleSheet(
    ...
    list_item=IEEE.list_item,
    equation=IEEE.equation,
    table_caption=IEEE.table_caption,
    table_header=IEEE.table_header,
    table_cell=IEEE.table_cell,
    figure_caption=IEEE.figure_caption,
    figure_body=IEEE.figure_body,
    code=IEEE.code,
    code_caption=IEEE.code_caption,
    reference=IEEE.reference,
    references_heading=IEEE.references_heading,
    ...
    code_caption_prefix=IEEE.code_caption_prefix,
    code_caption_position=IEEE.code_caption_position,
